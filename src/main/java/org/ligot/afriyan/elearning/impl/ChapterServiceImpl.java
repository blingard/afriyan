...
public class ChapterServiceImpl implements ChapterService {
    ...
    public ChapterServiceImpl(ChapitresMapper mapper, ChapterRepo repo, ParagraphService paragraphService, FormationsRepo formationsRepo, FileStorageService fileStorageService) {
        this.mapper = mapper;
        this.repo = repo;
