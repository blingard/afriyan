...
public class AlertsDTO {
    ...
    private AlertRiskTypeDTO riskType; // Nature du risque: SECHERESSE, INONDATION, CONFLIT, VBG [5, 9]
    ...
    public AlertsDTO(UUID id, String title, String description, AlertRiskTypeDTO riskType, LocalitiesDTO localities, AlertStatus status, String reporterUserId, String currentValidatorRole, String validationComments, LocalDateTime createdAt, LocalDateTime lastUpdatedAt) {
        this.id = id;
        this.title = title;
